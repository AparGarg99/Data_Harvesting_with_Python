...
def app():  
    ...
    api_key = st.sidebar.text_input('API Key', key='twentyeight')
    email_subject = st.sidebar.text_input('Email Subject', key='twentynine')
    sender_email_address = st.sidebar.text_input('Sender Email Address', key='thirty')
    sender_password = st.sidebar.text_input('Sender Email Password', type='password', key='thirtyone')
    receiver_email_address = st.sidebar.file_uploader('Receiver Email Address', key = 'thirtytwo')
    email_content = st.text_area('Body of Email', key ='thirtythree')
