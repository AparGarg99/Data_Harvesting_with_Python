...
* Employed anti-blocking techniques including setting random time intervals between requests, clearing cookies from time to time, and using proxy servers and user agents.
